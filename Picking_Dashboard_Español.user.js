...
document.getElementById('orchajs_obd_heading_less15min').innerHTML = "<15m Para Slam";
...
document.getElementById('orchajs_obd_heading_more4h').innerHTML = "Ventanas Futuras<BR>";
