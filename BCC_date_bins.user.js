// ==UserScript==
// @name         Nº de Bins y fecha limite BCC
// @namespace    https://github.com/atehortg/scripts
// @version      1.0
// @description  Muestra la fecha limite para los conteos y muestra el número de bines.
// @author       atehortg@
// @match        https://aftlite-portal-eu.amazon.com/bcc/assign*
// @match        https://aftlite-portal-eu.amazon.com/bcc_admin/assign*
// @grant        none
// ==/UserScript==

(function() {
    let table = window.location.href.match("aftlite-eu") ? document.querySelectorAll("table")[1] : document.querySelectorAll("table")[0];
    let head = document.createElement("th");
    head.innerHTML = "Fecha limite";
    table.children[0].children[0].appendChild(head);
    let head2 = document.createElement("th");
    head2.innerHTML = "Nº de Bins";
    ...
    btn.innerHTML = "Cargar bins";
    head2.after(btn);
    btn.onclick = function() {
        for(let row of table.rows) {
        // check the time for due date
            try{
                let listLink = row.children[0].getElementsByTagName("a")[0].href.replace("https://aftlite-eu.amazon.com", "");
                ...
                req.onload = function() {
                    ...
                    let complete = 0;
                    var bins = 0;
                    if(window.location.href.match("aftlite-eu")) {
