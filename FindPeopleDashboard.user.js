...
(function() {
    if(window.location.href.match("aftlite-eu")) {
        ...
        label.innerHTML = "Auto Refrescar (2 Minutos)";
        ...
        cbLabel.innerHTML = "Auto Refrescar (2 Minutos)";
...
function getIndirectForm() {
    ...
    submitButton.onclick = function() {
        ...
        let action = window.location.href.match("aftlite-eu") ? '/indirect_action/signin_indirect_action' : '/indirect_action/validate_name_and_code';
...
function submitIndirectForm(login, code, indirectForm) {
    ...
    let request = new XMLHttpRequest();
    let action = window.location.href.match("aftlite-") ? '/indirect_action/signin_indirect_action' : '/indirect_action/validate_name_and_code';
    request.open('POST', action);
    request.responseType = "document";
    request.onload = function() {
        let f = document.getElementById("Flash");
